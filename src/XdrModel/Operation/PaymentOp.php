...
class PaymentOp extends Operation
{
    ...
    /*
    /* fungsi tambahan untuk pembayaran token dan xlm tanpa harus pake Secret Key
    */
    public static function xlmPayment($destinationAccountId, $amount, $sourceAccountId = null)
    {
        $op = new PaymentOp($sourceAccountId);
        $op->destination = new AccountId($destinationAccountId);
        $op->asset = Asset::newNativeAsset();
